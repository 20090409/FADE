...
class UPVUtils:
    ...
    def _get_generator_model(self, input_dim: int, window_size: int) -> UPVGenerator:
        ...
        #model.load_state_dict(torch.load(self.config.generator_model_name, map_location='cpu'))
    ...
    def _get_detector_model(self, bit_number: int) -> UPVDetector:
        ...
        #model.load_state_dict(torch.load(self.config.detector_model_name,map_location='cpu'))
